...
export class SignInView extends AbstractView {
  constructor(params) {
    super(params);
        ...
        <form class="mt-8 space-y-6" action="#">
          ...
          <div class="flex items-start">
            ...
            <div class="ml-3 text-sm">
              ...
              <a href="#" class="ml-auto text-sm text-primary hover:underline dark:text-primary">Lost Password?</a>
          </div>
          <button type="submit" class="w-full px-5 py-3 text-base font-medium text-center text-white bg-primary rounded-lg hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 sm:w-auto dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Login to your account</button>
          <div class="text-sm font-medium text-gray-500 dark:text-gray-400">
              Not registered? <a class="text-primary hover:underline dark:text-primary-500">Create account</a>
          </div>
        </form>
    </div>
  </div>
